...
export const PropertyNav = ({IsNavVisible} : {IsNavVisible : boolean}) => {
  return (
    <nav className ={`fixed w-full h-20 py-0 px-10 lg:px-20 xl:px-36 p-3 bg-white z-20 border-t md:border-b flex justify-between items-center ${IsNavVisible?"opacity-100" : "md:opacity-0 md:invisible"} md:top-0 bottom-0`}>
